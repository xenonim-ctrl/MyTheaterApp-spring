...
```bash
git clone https://github.com/xenonim-ctrl/MyTheaterApp-spring.git
cd MyTheaterApp-spring
```
### 1. Создать базу данных в PostgreSQL (или другом)

```
CREATE DATABASE your_bd_name;
```
